...
@section('title', __('Create Sticker'))

@section('content')
    <x-forms.post :action="route('admin.ipsticker.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create IP Sticker')
            </x-slot>
            ...
            <x-slot name="body">
                <div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="user_name" id="user_name" class="form-control" placeholder="{{ __('User Name') }}" value="{{ old('user_name') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="computer_name" id="computer_name"  class="form-control" placeholder="{{ __('Computer Name') }}" value="{{ old('computer_name') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="ip_address" id="ip_address"  class="form-control" placeholder="{{ __('IP Address') }}" value="{{ old('ip_address') }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                </div>
            </x-slot>
